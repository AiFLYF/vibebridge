...
this repository. Running this script regenerates
skills/vibebridge/examples/example_user from scratch plus a ready to open
demo report.
"""
import os
import shutil
...
OUT = SKILL / "examples" / "example_user"
DEMO_REPORT = SKILL / "examples" / "demo_report.html"
...
def main():
    ...
    subprocess.run([sys.executable, str(SKILL / "scripts" / "vb.py"),
                    "report", "--window", "30D"],
